package com.flights.account.email;
...
import com.flights.account.FlightsManagementApplication;
...
import com.flights.account.service.EventService;
import com.flights.account.service.JwtService;
import com.flights.account.service.UserService;
import com.flights.account.utility.JsonUtil;

/**
 * ClasaEmail tests the functioning of the email sending system
 *
 */
@SpringBootTest(classes=FlightsManagementApplication.class)
